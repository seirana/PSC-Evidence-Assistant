...
class LLMClient:
    ...
    def _generate_ollama(
        ...
        # Ollama accepts a complete JSON Schema in `format`.
        # This constrains small models to return the required
        # object instead of a list or the schema itself.
        if json_schema is not None:
            payload["format"] = json_schema

        elif self._expects_json(prompt):
            payload["format"] = "json"
